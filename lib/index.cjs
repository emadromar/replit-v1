...
exports.generateInstagramCaptions = (0, https_1.onCall)(async (request) => {
    if (!request.auth) {
        logger.error("Authentication failed: User was not authenticated.");
...
exports.analyzeProduct = (0, https_1.onCall)(async (request) => {
    if (!request.auth) {
...
exports.generateBrandColor = (0, https_1.onCall)(async (request) => {
    if (!request.auth) {
        logger.error("Authentication failed: User was not authenticated.");
        throw new https_1.HttpsError('unauthenticated', 'You must be logged in to use this feature.');
    }
